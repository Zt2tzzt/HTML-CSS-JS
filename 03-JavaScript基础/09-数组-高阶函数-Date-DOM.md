...
- 地球公转有一定的误差，也会造成 GMT 的时间有一定的误差，于是就提出了根据原子钟计算的标准时间 UTC（Coordinated Universal Time）
...
日期的表示标准有哪 2 种？它们的格式是怎样的？对应的转化方法。
...
利用 Date 对象，获取**当前时间**的时间戳的方式 4 种。
