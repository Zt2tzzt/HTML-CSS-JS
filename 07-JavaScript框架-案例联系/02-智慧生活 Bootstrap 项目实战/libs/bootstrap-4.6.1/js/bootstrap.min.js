...
!(function (t, e) {
      ...
      return (
        ...
        (e._getRootElement = function (t) {
          var e = d.getSelectorFromElement(t),
            n = !1
          return (
            e && (n = document.querySelector(e)), n || (n = o.default(t).closest('.alert')[0]), n
          )
        }),
  ...
  o
    .default(document)
    .on('click.bs.alert.data-api', '[data-dismiss="alert"]', g._handleDismiss(new g())),
      ...
      return (
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if ((n || ((n = new t(this, i)), o.default(this).data(w, n)), 'number' == typeof e))
              n.to(e)
  ...
  o
    .default(document)
    .on('click.bs.carousel.data-api', '[data-slide], [data-slide-to]', P._dataApiClickHandler),
      ...
      return (
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (n ||
                ((n = new t(this, 'object' == typeof e ? e : null)), o.default(this).data(K, n)),
              'string' == typeof e)
            ) {
        ...
        (t._clearMenus = function (e) {
          if (!e || (3 !== e.which && ('keyup' !== e.type || 9 === e.which)))
            for (
              var n = [].slice.call(document.querySelectorAll(it)), i = 0, a = n.length;
              i < a;
              i++
            ) {
        ...
        (t._dataApiKeydownHandler = function (e) {
          if (
            !(/input|textarea/i.test(e.target.tagName)
              ? 32 === e.which ||
                (27 !== e.which &&
                  ((40 !== e.which && 38 !== e.which) || o.default(e.target).closest(ot).length))
              : !Y.test(e.which)) &&
            !this.disabled &&
      ...
      return (
        ...
        (e.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            o.default(s).data(this.constructor.DATA_KEY, this),
              o.default.contains(this.element.ownerDocument.documentElement, this.tip) ||
        ...
        (e.setElementContent = function (t, e) {
          'object' != typeof e || (!e.nodeType && !e.jquery)
            ? this.config.html
              ? (this.config.sanitize && (e = At(e, this.config.whiteList, this.config.sanitizeFn)),
                t.html(e))
              : t.text(e)
            : this.config.html
        ...
        (e._getConfig = function (t) {
          ...
          return (
            ...
            'number' ==
              typeof (t = r({}, this.constructor.Default, e, 'object' == typeof t && t ? t : {}))
  ...
  var Gt = 'scrollspy',
    ...
    se = (function () {
      ...
      return (
        ...
        (e._getConfig = function (t) {
          if (
            'string' != typeof (t = r({}, oe, 'object' == typeof t && t ? t : {})).target &&
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (n || ((n = new t(this, 'object' == typeof e && e)), o.default(this).data(Zt, n)),
              'string' == typeof e)
            ) {
              if ('undefined' == typeof n[e]) throw new TypeError('No method named "' + e + '"')
              n[e]()
