...
!(function (t, e) {
      ...
      return (
        ...
        (e._getRootElement = function (t) {
          var e = u.getSelectorFromElement(t),
            n = !1
          return (
            e && (n = document.querySelector(e)), n || (n = i.default(t).closest('.alert')[0]), n
          )
        }),
  ...
  i
    .default(document)
    .on('click.bs.alert.data-api', '[data-dismiss="alert"]', c._handleDismiss(new c())),
  ...
  i
    ...
    i.default(window).on('load.bs.button.data-api', function () {
      ...
      for (
        var r = 0,
          a = (t = [].slice.call(document.querySelectorAll('[data-toggle="button"]'))).length;
        r < a;
        r++
      ) {
        var s = t[r]
      ...
      return (
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if ((n || ((n = new t(this, o)), i.default(this).data(E, n)), 'number' == typeof e))
              n.to(e)
  ...
  i
    .default(document)
    .on('click.bs.carousel.data-api', '[data-slide], [data-slide-to]', O._dataApiClickHandler),
            ...
            if ((i.default(this._element).trigger(r), !r.isDefaultPrevented())) {
              ...
              i.default(this._element).removeClass(F).addClass(R),
                ...
                this._triggerArray.length &&
                  i.default(this._triggerArray).removeClass(H).attr('aria-expanded', !0),
  ...
  function it(t, e) {
    ...
    if ((t !== l && e !== l) || i.contains(o))
      return 'BODY' === (s = (a = l).nodeName) || ('HTML' !== s && et(a.firstElementChild) !== a)
        ? et(l)
        : l
    var u = nt(t)
  ...
  function Pt() {
    this.state.eventsEnabled ||
      (this.state = Lt(this.reference, this.options, this.state, this.scheduleUpdate))
  }
  function Ft() {
    var t, e
    this.state.eventsEnabled &&
            ...
            var u = e.priority,
              ...
              d = {
                primary: function (t) {
                  var n = f[t]
                  return (
                    f[t] < l[t] && !e.escapeWithReference && (n = Math.max(f[t], l[t])),
                    dt({}, t, n)
                  )
                },
      ...
      return (
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (n ||
                ((n = new t(this, 'object' == typeof e ? e : null)), i.default(this).data(Kt, n)),
              'string' == typeof e)
            ) {
        ...
        (t._clearMenus = function (e) {
          if (!e || (3 !== e.which && ('keyup' !== e.type || 9 === e.which)))
            for (
              var n = [].slice.call(document.querySelectorAll(oe)), o = 0, r = n.length;
              o < r;
              o++
            ) {
        ...
        (t._dataApiKeydownHandler = function (e) {
          if (
            !(/input|textarea/i.test(e.target.tagName)
              ? 32 === e.which ||
                (27 !== e.which &&
                  ((40 !== e.which && 38 !== e.which) || i.default(e.target).closest(re).length))
              : !Gt.test(e.which)) &&
            !this.disabled &&
      ...
      return (
        ...
        (e.setElementContent = function (t, e) {
          'object' != typeof e || (!e.nodeType && !e.jquery)
            ? this.config.html
              ? (this.config.sanitize && (e = ke(e, this.config.whiteList, this.config.sanitizeFn)),
                t.html(e))
              : t.text(e)
            : this.config.html
        ...
        (e._getConfig = function (t) {
          ...
          return (
            ...
            'number' ==
              typeof (t = a({}, this.constructor.Default, e, 'object' == typeof t && t ? t : {}))
  ...
  var Ze = 'scrollspy',
    ...
    ln = (function () {
      ...
      return (
        ...
        (e._getConfig = function (t) {
          if (
            'string' != typeof (t = a({}, an, 'object' == typeof t && t ? t : {})).target &&
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (n || ((n = new t(this, 'object' == typeof e && e)), i.default(this).data(tn, n)),
              'string' == typeof e)
            ) {
              if ('undefined' == typeof n[e]) throw new TypeError('No method named "' + e + '"')
              n[e]()
  ...
  i.default(window).on('load.bs.scrollspy.data-api', function () {
    for (
      var t = [].slice.call(document.querySelectorAll('[data-spy="scroll"]')), e = t.length;
      e--;
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            var n = i.default(this),
              o = n.data(_n)
            if (
              (o || ((o = new t(this, 'object' == typeof e && e)), n.data(_n, o)),
              'string' == typeof e)
            ) {
              if ('undefined' == typeof o[e]) throw new TypeError('No method named "' + e + '"')
              o[e](this)
