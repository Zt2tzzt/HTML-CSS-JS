...
!(function (e, t) {
  ...
  var i = function (t, i, n) {
    ...
    s = (function () {
      function e(e, t) {
        ...
        for (
          var i = [],
            n = i.concat(['encodeBase64', 'mimeLookup', 'charsetLookup', 'getSourceMapGenerator']),
            r = 0;
          r < n.length;
          r++
        ) {
    ...
    u = (function () {
      ...
      return (
        ...
        (e.compare = function (t, i) {
          if (t.compare && 'Quoted' !== i.type && 'Anonymous' !== i.type) return t.compare(i)
          if (i.compare) return -i.compare(t)
          if (t.type === i.type) {
            if (((t = t.value), (i = i.value), !Array.isArray(t))) return t === i ? 0 : void 0
            if (t.length === i.length) {
              for (var n = 0; n < t.length; n++) if (0 !== e.compare(t[n], i[n])) return
              return 0
            }
          }
        }),
  ...
  ;(c.prototype = Object.assign(new u(), {
    ...
    luma: function () {
      var e = this.rgb[0] / 255,
        ...
        i = this.rgb[2] / 255
      return (
        0.2126 * (e = e <= 0.03928 ? e / 12.92 : Math.pow((e + 0.055) / 1.055, 2.4)) +
        0.7152 * (t = t <= 0.03928 ? t / 12.92 : Math.pow((t + 0.055) / 1.055, 2.4)) +
        0.0722 * (i = i <= 0.03928 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4))
      )
    },
    genCSS: function (e, t) {
      t.add(this.toCSS(e))
      ...
      S(e)
        ...
        : (function () {
            ...
            var n = Array(e),
              r = 0
            for (t = 0; t < i; t++)
              for (var s = arguments[t], o = 0, a = s.length; o < a; o++, r++) n[r] = s[o]
            return n
          })(Object.getOwnPropertyNames(e), Object.getOwnPropertySymbols(e)).reduce(function (
            i,
            n
          ) {
            return (
    ...
    O = function (e, t, i) {
      ...
      if (((this.message = e.message), (this.stack = e.stack), t && n)) {
        ...
        if (
          ...
          var c = this.stack.match(R),
            h = new Function('a', 'throw new Error()'),
            f = 0
          try {
            h()
          } catch (e) {
            var p = e.stack.match(R)
            f = 1 - (o = parseInt(p[2]))
          }
          c && (c[2] && (this.line = parseInt(c[2]) + f), c[3] && (this.column = parseInt(c[3])))
        }
        ;(this.callLine = l + 1),
  ...
  ;(O.prototype.constructor = O),
    (O.prototype.toString = function (e) {
        ...
        if (
          ...
          i[1] &&
            (o +=
              ...
              r(
                r(r(i[1].substr(this.column, 1), 'bold') + i[1].slice(this.column + 1), 'red'),
                'inverse'
              )),
            n.push(o)
        }
      ...
      return (
        ...
        this.line &&
          (t += r(' on line ' + this.line + ', column ' + (this.column + 1) + ':', 'grey')),
        (t += '\n' + n),
        this.callLine &&
  ...
  F.prototype = Object.assign(new u(), {
    ...
    getElements: function (e) {
      return e
        ? ('string' == typeof e &&
            this.parse.parseNode(e, ['selector'], this._index, this._fileInfo, function (t, i) {
              if (t)
                throw new O(
    ...
    createEmptySelectors: function () {
      var e = new m('', '&', !1, this._index, this._fileInfo),
        t = [new F([e], null, null, this._index, this._fileInfo)]
  ...
  j.prototype = Object.assign(new u(), {
    ...
    genCSS: function (e, t) {
      ;(this.nodeVisible = Boolean(this.value)),
        this.nodeVisible && t.add(this.value, this._fileInfo, this._index, this.mapLines)
    }
  })
  var N = g
  var D = function (e, t, i, n, r, s, o, a) {
    ;(this.name = e),
      (this.value = t instanceof u ? t : new $([t ? new j(t) : null])),
  ...
  D.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      'string' != typeof r &&
        ...
        'font' === r &&
          e.math === N.ALWAYS &&
          ((n = !0), (t = e.math), (e.math = N.PARENS_DIVISION))
      try {
        if (
        ...
        return (
          ...
          new D(r, i, o, this.merge, this.getIndex(), this.fileInfo(), this.inline, s)
        )
      } catch (e) {
        throw (
        ...
        if (t.dumpLineNumbers && !t.compress)
          switch (t.dumpLineNumbers) {
            ...
            case 'mediaquery':
              ...
              break
            case 'all':
              r = e.asComment(i) + (n || '') + e.asMediaQuery(i)
          }
        return r
      }
      return (
        (e.asComment = function (e) {
          return '/* line ' + e.debugInfo.lineNumber + ', ' + e.debugInfo.fileName + ' */\n'
        }),
        (e.asMediaQuery = function (e) {
  ...
  U.prototype = Object.assign(new u(), {
    type: 'Comment',
    genCSS: function (e, t) {
      this.debugInfo && t.add(B(e, this), this.fileInfo(), this.getIndex()), t.add(this.value)
    },
    isSilent: function (e) {
  ...
  q.Parse = function (e) {
    T(e, this, z), 'string' == typeof this.paths && (this.paths = [this.paths])
  }
  var G = [
    'paths',
    'compress',
  ...
  ;(q.Eval = function (e, t) {
    ...
    (q.Eval.prototype.inCalc = !1),
    (q.Eval.prototype.mathOn = !0),
    (q.Eval.prototype.isMathOn = function (e) {
      return (
        !!this.mathOn &&
        !!('/' !== e || this.math === g.ALWAYS || (this.parensStack && this.parensStack.length)) &&
        (!(this.math > g.PARENS_DIVISION) || (this.parensStack && this.parensStack.length))
      )
    }),
    (q.Eval.prototype.pathRequiresRewrite = function (e) {
      return (this.rewriteUrls === b ? J : W)(e)
    }),
    (q.Eval.prototype.rewritePath = function (e, t) {
      var i
      return (
        (t = t || ''),
    ...
    (q.Eval.prototype.normalizePath = function (e) {
      var t,
        i = e.split('/').reverse()
      for (e = []; 0 !== i.length; )
        switch ((t = i.pop())) {
    ...
    Q = {
      eval: function () {
        var e = this.value_,
          t = this.error_
        if (t) throw t
        if (null != e) return e ? L.True : L.False
      },
      value: function (e) {
        this.value_ = e
      },
  ...
  K.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      var c,
        h,
        f = this.rules ? k(this.rules) : null,
        p = new K(t, f, this.strictImports, this.visibilityInfo())
      ...
      var m = p.rules
      for (r = 0; (c = m[r]); r++) c.evalFirst && (m[r] = c.eval(e))
      var g = (e.mediaBlocks && e.mediaBlocks.length) || 0
      for (r = 0; (c = m[r]); r++)
        'MixinCall' === c.type
          ? ((f = c.eval(e).filter(function (e) {
              return !(e instanceof D && e.variable) || !p.variable(e.name)
            })),
            m.splice.apply(m, [r, 1].concat(f)),
            (r += f.length - 1),
            p.resetCache())
          : 'VariableCall' === c.type &&
            ((f = c.eval(e).rules.filter(function (e) {
              return !(e instanceof D && e.variable)
            })),
            m.splice.apply(m, [r, 1].concat(f)),
            (r += f.length - 1),
            p.resetCache())
      for (r = 0; (c = m[r]); r++) c.evalFirst || (m[r] = c = c.eval ? c.eval(e) : c)
      for (r = 0; (c = m[r]); r++)
        if (
          c instanceof K &&
          c.selectors &&
          1 === c.selectors.length &&
          c.selectors[0] &&
          c.selectors[0].isJustParentSelector()
        ) {
          m.splice(r--, 1)
          for (a = 0; (h = c.rules[a]); a++)
            h instanceof u &&
              (h.copyVisibilityInfo(c.visibilityInfo()),
              (h instanceof D && h.variable) || m.splice(++r, 0, h))
        }
      if ((v.shift(), d.shift(), e.mediaBlocks))
        for (r = g; r < e.mediaBlocks.length; r++) e.mediaBlocks[r].bubbleSelectors(t)
      return p
    },
    ...
    matchCondition: function (e, t) {
      ...
      return !!i.evaldCondition && !(i.condition && !i.condition.eval(new q.Eval(t, t.frames)))
    },
    resetCache: function () {
      ;(this._rulesets = null),
        (this._variables = null),
        ...
        this._variables ||
          (this._variables = this.rules
            ? this.rules.reduce(function (e, t) {
                if (
                  (t instanceof D && !0 === t.variable && (e[t.name] = t),
                  'Import' === t.type && t.root && t.root.variables)
                ) {
                  var i = t.root.variables()
                  for (var n in i) i.hasOwnProperty(n) && (e[n] = t.root.variable(n))
                }
                return e
              }, {})
            : {}),
      ...
      return (
        this._properties ||
          (this._properties = this.rules
            ? this.rules.reduce(function (e, t) {
                if (t instanceof D && !0 !== t.variable) {
                  var i = 1 === t.name.length && t.name[0] instanceof L ? t.name[0].value : t.name
    ...
    lastDeclaration: function () {
      for (var e = this.rules.length; e > 0; e--) {
        ...
        if (t instanceof D) return this.parseValue(t)
      }
    },
    parseValue: function (e) {
      var t = this
      function i(e) {
        return e.value instanceof j && !e.parsed
          ? ('string' == typeof e.value.value
              ? this.parse.parseNode(
                  ...
                  function (t, i) {
                    t && (e.parsed = !0),
                      i && ((e.value = i[0]), (e.important = i[1] || ''), (e.parsed = !0))
                  }
                )
              : (e.parsed = !0),
            e)
              ...
              for (var a = 0; a < o.selectors.length; a++)
                if ((n = e.match(o.selectors[a]))) {
                  if (e.elements.length > n) {
                    if (!i || i(o)) {
                      r = o.find(new F(e.elements.slice(n)), t, i)
    ...
    genCSS: function (e, t) {
      ...
      for (i = 0; (s = a[i]); i++) {
        ...
        s.isRulesetLike(s) && (e.lastRule = !1),
          ...
          (e.lastRule = m),
          !e.lastRule && s.isVisible() ? t.add(e.compress ? '' : '\n' + u) : (e.lastRule = !1)
      }
    ...
    joinSelector: function (e, t, i) {
      ...
      function r(e, t) {
        var i
        return (i = new m(null, e, t.isVariable, t._index, t._fileInfo)), new F([i])
      }
      function s(e, t, i, n) {
        var r, s, o
        if (
          ...
          var a = i.combinator,
            l = t[0].elements[0]
          a.emptyOrWhitespace && !l.combinator.emptyOrWhitespace && (a = l.combinator),
            o.elements.push(new m(a, l.value, i.isVariable, i._index, i._fileInfo)),
        ...
        !(function e(t, i, l) {
          ...
          for (f = [], v = [[]], u = 0; (y = l.elements[u]); u++)
            if ('&' !== y.value) {
              var C =
                ((S = void 0),
                (x = y).value instanceof p && (S = x.value.value) instanceof F ? S : null)
              if (null != C) {
                a(f, v)
                var k,
                  _ = [],
              ...
              for (I = !0, d = [], a(f, v), c = 0; c < v.length; c++)
                if (((g = v[c]), 0 === i.length))
                  g.length > 0 &&
                    g[0].elements.push(
                      new m(y.combinator, '', y.isVariable, y._index, y._fileInfo)
                    ),
                    d.push(g)
                else
  ...
  var Z = function (e, t, i, n, r, s, o, a) {
    var l
    if (((this.name = e), (this.value = t instanceof u ? t : t ? new j(t) : t), i)) {
      for (
        Array.isArray(i)
          ? (this.rules = i)
          : ((this.rules = [i]),
            (this.rules[0].selectors = new F([], null, null, n, r).createEmptySelectors())),
          l = 0;
        l < this.rules.length;
        l++
      )
  ...
  Z.prototype = Object.assign(new u(), {
    ...
    variable: function (e) {
      if (this.rules) return K.prototype.variable.call(this.rules[0], e)
    },
    find: function () {
    ...
    outputRuleset: function (e, t, i) {
      ...
      var s = '\n' + Array(e.tabLevel).join('  '),
        o = s + '  '
      if (r) {
        for (t.add(' {' + o), i[0].genCSS(e, t), n = 1; n < r; n++) t.add(o), i[n].genCSS(e, t)
        t.add(s + '}')
      } else t.add(' {' + s + '}')
      e.tabLevel--
    }
  ...
  X.prototype = Object.assign(new u(), {
    ...
    callEval: function (e) {
      return this.ruleset.eval(this.frames ? new q.Eval(e, this.frames.concat(e.frames)) : e)
    }
  })
  ...
  Y.prototype = Object.assign(new u(), {
    ...
    isLength: function () {
      return RegExp('^(px|em|ex|ch|rem|in|cm|mm|pc|pt|ex|vw|vh|vmin|vmax)$', 'gi').test(
        this.toCSS()
      )
    },
    isEmpty: function () {
    ...
    cancel: function () {
      var e,
        t,
        i = {}
      for (t = 0; t < this.numerator.length; t++) i[(e = this.numerator[t])] = (i[e] || 0) + 1
      for (t = 0; t < this.denominator.length; t++) i[(e = this.denominator[t])] = (i[e] || 0) - 1
  ...
  var ee = function (e, t) {
    ...
    ;(this.unit = t && t instanceof Y ? t : new Y(t ? [t] : void 0)),
  ...
  ee.prototype = Object.assign(new u(), {
    ...
    genCSS: function (e, t) {
      ...
      var i = this.fround(e, this.value),
        n = String(i)
      if (
        (0 !== i && i < 1e-6 && i > -1e-6 && (n = i.toFixed(20).replace(/0+$/, '')),
        e && e.compress)
      ) {
    ...
    operate: function (e, t, i) {
      ...
      if ('+' === t || '-' === t)
        if (0 === r.numerator.length && 0 === r.denominator.length)
          (r = i.unit.clone()), this.unit.backupUnit && (r.backupUnit = this.unit.backupUnit)
    ...
    compare: function (e) {
      ...
      if (e instanceof ee) {
        ...
        else if (((t = this.unify()), (i = e.unify()), 0 !== t.unit.compare(i.unit))) return
  ...
  ie.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      if (e.isMathOn(this.op)) {
        if (
          ((t = './' === this.op ? '/' : this.op),
          i instanceof ee && n instanceof c && (i = i.toColor()),
          n instanceof ee && i instanceof c && (n = n.toColor()),
          !i.operate || !n.operate)
        ) {
          if ((i instanceof ie || n instanceof ie) && '/' === i.op && e.math === te.PARENS_DIVISION)
            return new ie(this.op, [i, n], this.isSpaced)
    ...
    eval: function (e) {
      ...
      return (
        ...
        this.value.length > 1
          ...
          : 1 === this.value.length
          ? (!this.value[0].parens || this.value[0].parensInOp || e.inCalc || (r = !0),
            (t = this.value[0].eval(e)))
          : (t = this),
        n && e.outOfParenthesis(),
        !this.parens || !this.parensInOp || i || r || t instanceof ee || (t = new p(t)),
        t
      )
    },
    genCSS: function (e, t) {
          ...
          return (
            (e = e.filter(n).map(function (e) {
              if ('Expression' === e.type) {
                ...
                return 1 === t.length ? (e.parens && '/' === t[0].op ? e : t[0]) : new ne(t)
              }
              return e
            })),
            !1 === i
  ...
  se.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      var n,
        ...
        s = new re(this.name, e, this.getIndex(), this.fileInfo())
      if (s.isValid())
        try {
          ...
          throw {
            type: e.type || 'Runtime',
            message:
              'Error evaluating function `' + this.name + '`' + (e.message ? ': ' + e.message : ''),
            index: this.getIndex(),
            filename: this.fileInfo().filename,
            line: e.lineNumber,
      ...
      if (null != n)
        return (
          n instanceof u || (n = new j(n && !0 !== n ? n.toString() : null)),
      ...
      return r(), new se(this.name, o, this.getIndex(), this.fileInfo())
    },
    genCSS: function (e, t) {
      t.add(this.name + '(', this.fileInfo(), this.getIndex())
  ...
  oe.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      if (
        (0 === i.indexOf('@@') &&
          (i = '@' + new oe(i.slice(1), this.getIndex(), this.fileInfo()).eval(e).value),
        this.evaluating)
      )
        throw {
          type: 'Name',
      ...
      if (
        ...
        (t = this.find(e.frames, function (t) {
          ...
          if (n) {
            ...
            return e.inCalc ? new se('_SELF', [n.value]).eval(e) : n.value.eval(e)
          }
        })))
      )
    ...
    find: function (e, t) {
      for (var i = 0, n = void 0; i < e.length; i++) if ((n = t.call(e, e[i]))) return n
      return null
    }
  })
        ...
        (t = this.find(e.frames, function (t) {
          ...
          if (s) {
            ...
            if ((n(s), (r = s[s.length - 1]).important))
              e.importantScope[e.importantScope.length - 1].important = r.important
  ...
  le.prototype = Object.assign(new u(), {
    ...
    toCSS: function (e) {
      ...
      return (
        this.op && ((t += this.op), (t += this.value.toCSS ? this.value.toCSS(e) : this.value)),
        '[' + t + ']'
      )
    }
  })
  var ue = function (e, t, i, n, r) {
    ...
    eval: function (e) {
      ...
      return (
        (i = n(i, this.variableRegex, function (i, n) {
          var r = new oe('@' + n, t.getIndex(), t.fileInfo()).eval(e, !0)
          return r instanceof ue ? r.value : r.toCSS()
        })),
        (i = n(i, this.propRegex, function (i, n) {
          var r = new ae('$' + n, t.getIndex(), t.fileInfo()).eval(e, !0)
          return r instanceof ue ? r.value : r.toCSS()
        })),
        new ue(this.quote + i + this.quote, i, this.escaped, this.getIndex(), this.fileInfo())
      )
    },
    compare: function (e) {
  ...
  ce.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      return new ce(i, this.getIndex(), this.fileInfo(), !0)
    }
  })
  var he = function (e, t, i, n, r) {
    ;(this._index = i), (this._fileInfo = n)
    var s = new F([], null, null, this._index, this._fileInfo).createEmptySelectors()
    ;(this.features = new $(t)),
      (this.rules = [new K(s, e)]),
  ...
  he.prototype = Object.assign(new Z(), {
    ...
    eval: function (e) {
      ...
      var t = new he(null, [], this._index, this._fileInfo, this.visibilityInfo())
      return (
        this.debugInfo &&
          ((this.rules[0].debugInfo = this.debugInfo), (t.debugInfo = this.debugInfo)),
    ...
    evalTop: function (e) {
      ...
      if (e.mediaBlocks.length > 1) {
        var i = new F([], null, null, this.getIndex(), this.fileInfo()).createEmptySelectors()
        ;((t = new K(i, e.mediaBlocks)).multiMedia = !0),
    ...
    evalNested: function (e) {
      ...
      for (t = 0; t < n.length; t++)
        (i = n[t].features instanceof $ ? n[t].features.value : n[t].features),
      ...
      return (
        (this.features = new $(
          this.permute(n).map(function (e) {
            for (
              e = e.map(function (e) {
                return e.toCSS ? e : new j(e)
              }),
                t = e.length - 1;
              t > 0;
              t--
            )
              e.splice(t, 0, new j('and'))
            return new ne(e)
          })
        )),
        this.setParent(this.features, this),
    ...
    bubbleSelectors: function (e) {
      e && ((this.rules = [new K(k(e), [this.rules[0]])]), this.setParent(this.rules, this))
    }
  })
  ...
  fe.prototype = Object.assign(new u(), {
    ...
    isVariableImport: function () {
      var e = this.path
      return e instanceof ce && (e = e.value), !(e instanceof ue) || e.containsVariables()
    },
    evalForImport: function (e) {
      var t = this.path
      return (
        t instanceof ce && (t = t.value),
        new fe(
          t.eval(e),
          this.features,
          this.options,
    ...
    doEval: function (e) {
        ...
        if (this.root && this.root.eval)
          try {
            ...
            throw (
              ...
              new O(e, this.root.imports, this.root.filename))
            )
          }
        return (
      ...
      if (this.options.inline) {
        ...
        return this.features ? new he([r], this.features.value) : [r]
      }
      if (this.css) {
      ...
      return this.root
        ? ((t = new K(null, k(this.root.rules))).evalImports(e),
          this.features ? new he(t.rules, this.features.value) : t.rules)
        : []
    }
  })
  var pe = function () {}
  pe.prototype = Object.assign(new u(), {
    evaluateJavaScript: function (e, t) {
      ...
      e = e.replace(/@\{([\w-]+)\}/g, function (e, i) {
        return n.jsify(new oe('@' + i, n.getIndex(), n.fileInfo()).eval(t))
      })
      try {
      ...
      try {
        ...
        throw {
          message:
            "JavaScript evaluation error: '" + e.name + ': ' + e.message.replace(/["]/g, "'") + "'",
          filename: this.fileInfo().filename,
          index: this.getIndex()
        }
      }
  ...
  de.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      return this.value.eval ? new de(this.key, this.value.eval(e)) : this
    },
    genCSS: function (e, t) {
      t.add(this.key + '='), this.value.genCSS ? this.value.genCSS(e, t) : t.add(this.value)
    }
  })
  var me = function (e, t, i, n, r) {
    ;(this.op = e.trim()),
      (this.lvalue = t),
      (this.rvalue = i),
      (this._index = n),
  ...
  ge.prototype = Object.assign(new u(), { type: 'UnicodeDescriptor' })
  var ye = function (e) {
    this.value = e
  }
  ye.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      return e.isMathOn()
        ? new ie('*', [new ee(-1), this.value]).eval(e)
        : new ye(this.value.eval(e))
    }
  })
  ...
  ;(be.prototype = Object.assign(new u(), {
    ...
    findSelfSelectors: function (e) {
      ...
      for (t = 0; t < e.length; t++)
        (i = e[t].elements),
          t > 0 && i.length && '' === i[0].combinator.value && (i[0].combinator.value = ' '),
          (n = n.concat(e[t].elements))
      ;(this.selfSelectors = [new F(n)]),
  ...
  we.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      var t,
        i = new oe(this.variable, this.getIndex(), this.fileInfo()).eval(e),
        n = new O({ message: 'Could not evaluate variable call ' + this.variable })
      if (!i.ruleset) {
        if (i.rules) t = i
        else if (Array.isArray(i)) t = new K('', i)
        else {
  ...
  xe.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      for (t = 0; t < this.lookups.length; t++) {
        if (((i = this.lookups[t]), Array.isArray(n) && (n = new K([new F()], n)), '' === i))
          n = n.lastDeclaration()
        else if ('@' === i.charAt(0)) {
          if (
            ('@' === i.charAt(1) && (i = '@' + new oe(i.substr(1)).eval(e).value),
          ...
          if (
            ((i =
              '$@' === i.substring(0, 2)
                ? '$' + new oe(i.substr(1)).eval(e).value
                : '$' === i.charAt(0)
                ? i
                : '$' + i),
  ...
  var Se = function (e, t, i, n, r, s, o) {
    ;(this.name = e || 'anonymous mixin'),
      (this.selectors = [new F([new m(null, e, !1, this._index, this._fileInfo)])]),
      (this.params = t),
      (this.condition = n),
      (this.variadic = r),
      (this.arity = t.length),
  ...
  Se.prototype = Object.assign(new K(), {
    ...
    evalParams: function (e, t, i, n) {
      ...
      if (
        ...
        (t = new q.Eval(t, [f].concat(t.frames))),
        i)
      )
        for (v = (i = k(i)).length, o = 0; o < v; o++)
          if ((u = (s = i[o]) && s.name)) {
            for (c = !1, a = 0; a < p.length; a++)
              if (!n[a] && u === p[a].name) {
                ;(n[a] = s.value.eval(e)), f.prependRule(new D(u, s.value.eval(e))), (c = !0)
                break
              }
            if (c) {
              i.splice(o, 1), o--
        ...
        if (!n[o]) {
          if (((s = i && i[h]), (u = p[o].name)))
            if (p[o].variadic) {
              ...
              f.prependRule(new D(u, new ne(r).eval(e)))
            } else {
              if ((l = s && s.value)) l = Array.isArray(l) ? new X(new K('', l)) : l.eval(e)
              else {
                if (!p[o].value)
                  throw {
                    type: 'Runtime',
              ...
              f.prependRule(new D(u, l)), (n[o] = l)
            }
          if (p[o].variadic && i) for (a = h; a < v; a++) n[a] = i[a].value.eval(e)
          h++
        }
      return f
    },
    makeImportant: function () {
      var e = this.rules
        ...
        : this.rules
      return new Se(this.name, this.params, e, this.condition, this.variadic, this.frames)
    },
    eval: function (e) {
      return new Se(
        this.name,
    ...
    evalCall: function (e, t, i) {
      var n,
        ...
        a = this.evalParams(e, new q.Eval(e, o), t, s)
      return (
        a.prependRule(new D('@arguments', new ne(s).eval(e))),
        (n = k(this.rules)),
        ((r = new K(null, n)).originalRuleset = this),
        (r = r.eval(new q.Eval(e, [this, a].concat(o)))),
        i && (r = r.makeImportant()),
        r
      )
    },
        ...
        !this.condition.eval(
          new q.Eval(
            ...
            [
              this.evalParams(
                t,
                new q.Eval(t, this.frames ? this.frames.concat(t.frames) : t.frames),
                e,
                []
              )
            ]
  ...
  var Ie = function (e, t, i, n, r) {
    ;(this.selector = new F(e)),
      (this.arguments = t || []),
      (this._index = i),
      (this._fileInfo = n),
      (this.important = r),
  ...
  Ie.prototype = Object.assign(new u(), {
    ...
    eval: function (e) {
      ...
      function x(t, i) {
        var n, r, s
        for (n = 0; n < 2; n++) {
          for (w[n] = !0, Q.value(n), r = 0; r < i.length && w[n]; r++)
        ...
        if ((t = e.frames[o].find(this.selector, null, d)).length > 0) {
          for (c = !0, a = 0; a < t.length; a++) {
            for (i = t[a].rule, n = t[a].path, u = !1, l = 0; l < e.frames.length; l++)
              if (!(i instanceof Se) && i === (e.frames[l].originalRuleset || e.frames[l])) {
                u = !0
                break
              }
            u ||
              (i.matchArgs(m, e) &&
                (-1 !== (h = { mixin: i, group: x(i, n) }).group && b.push(h), (y = !0)))
          }
          for (Q.reset(), p = [0, 0, 0], a = 0; a < b.length; a++) p[b[a].group]++
          if (p[0] > 0) f = 2
          else if (((f = 1), p[1] + p[2] > 1))
            throw {
              type: 'Runtime',
              message:
                'Ambiguous use of `default()` found when matching for `' + this.format(m) + '`',
              index: this.getIndex(),
              filename: this.fileInfo().filename
            }
    ...
    _setVisibilityToReplacement: function (e) {
      var t
      if (this.blocksVisibility()) for (t = 0; t < e.length; t++) e[t].addVisibilityBlock()
    },
    format: function (e) {
      return (
    ...
    ke = (function () {
      ...
      return (
        ...
        (e.prototype.extractUrlParts = function (e, t) {
          ...
          if (s[3])
            for (a = s[3].replace(/\\/g, '/').split('/'), i = 0; i < a.length; i++)
      ...
      return (
        (e.prototype.evalPlugin = function (e, t, i, n, r) {
          ...
          if (u && (o = l.get(u))) {
            ...
            try {
              ...
              return (e.message = e.message || 'Error during @plugin call'), new O(e, i, u)
            }
            return o
          }
          ;(a = { exports: {}, pluginManager: l, fileInfo: r }), (s = H.create())
          try {
            new Function(
              'module',
              'require',
          ...
          if ((o || (o = a.exports), (o = this.validatePlugin(o, u, h)) instanceof O)) return o
          if (!o) return new O({ message: 'Not a valid plugin' }, i, u)
          if (
            ((o.imports = i),
            (o.filename = u),
        ...
        (e.prototype.trySetOptions = function (e, t, i, n) {
          if (n && !e.setOptions)
            return new O({
              message:
                'Options have been provided but the plugin ' + i + ' does not support any options.'
            })
          try {
        ...
        (e.prototype.validatePlugin = function (e, t, i) {
          return e
            ? ('function' == typeof e && (e = new e()),
              e.minVersion && this.compareVersion(e.minVersion, this.less.version) < 0
                ? new O({
                    message:
                      'Plugin ' + i + ' requires version ' + this.versionToString(e.minVersion)
                  })
                : e)
            : null
        }),
  ...
  var Pe = (function () {
      ...
      return (
        (e.prototype.visit = function (e) {
          ...
          if (o.visitDeeper && e)
            if (e.length) for (var l = 0, u = e.length; l < u; l++) e[l].accept && e[l].accept(this)
            else e.accept && e.accept(this)
          return s != Ee && s.call(n, e), e
        }),
  ...
  Oe.prototype = {
    ...
    visitImport: function (e, t) {
      ...
      if (!e.css || i) {
        var n = new q.Eval(this.context, k(this.context.frames)),
          r = n.frames[0]
        this.importCount++,
          e.isVariableImport()
            ? this._sequencer.addVariableImport(this.processImportNode.bind(this, e, n, r))
    ...
    processImportNode: function (e, t, i) {
      ...
      try {
        ...
        t.filename || ((t.index = e.getIndex()), (t.filename = e.fileInfo().filename)),
          (e.css = !0),
          (e.error = t)
      }
    ...
    onImported: function (e, t, i, n, r, s) {
      ...
      if (
        ...
        !s && u && (e.skip = !0),
        n && ((e.root = n), (e.importedFilename = s), !a && !l && (t.importMultiple || !c)))
      ) {
  ...
  var Ve = (function () {
        ...
        (e.prototype.visitRuleset = function (e, t) {
          if (!e.root) {
            var i,
              ...
              l = a ? a.length : 0
            for (i = 0; i < l; i++)
              e.rules[i] instanceof Ce.Extend && (o.push(a[i]), (e.extendOnEveryPath = !0))
            var u = e.paths
      ...
      return (
        ...
        (e.prototype.checkExtendsForNonMatched = function (e) {
          ...
          e.filter(function (e) {
            ...
            t[e.index + ' ' + i] ||
              ((t[e.index + ' ' + i] = !0), r.warn("extend '" + i + "' has no matches"))
          })
        }),
                  ...
                  (s = f.findMatch(l, a)).length &&
                    ...
                    l.selfSelectors.forEach(function (e) {
                      ...
                      ;(o = f.extendSelector(s, a, e, l.isVisible())),
                        ...
                        h.push(c),
                        (c.ruleset = u.ruleset),
                        (c.parent_ids = c.parent_ids.concat(u.parent_ids, l.parent_ids)),
                        u.firstExtendOnThisSelectorPath &&
                          ((c.firstExtendOnThisSelectorPath = !0), u.ruleset.paths.push(o))
                    })))
          if (h.length) {
              ...
              for (
                s = n.elements[r],
                  (e.allowBefore || (0 === i && 0 === r)) &&
                    c.push({ pathIndex: i, index: r, matched: 0, initialCombinator: s.combinator }),
                  a = 0;
                a < c.length;
                a++
              )
        ...
        (e.prototype.isElementValuesEqual = function (e, t) {
          ...
          if (((e = e.value), (t = t.value), e instanceof Ce.Selector)) {
            if (!(t instanceof Ce.Selector) || e.elements.length !== t.elements.length) return !1
          ...
          for (r = 0; r < e.length; r++)
            (s = t[(a = e[r]).pathIndex]),
              ...
              a.pathIndex > u &&
                ...
                (c = 0),
                u++),
              (l = s.elements.slice(c, a.index).concat([o]).concat(i.elements.slice(1))),
              u === a.pathIndex && r > 0
                ? (h[h.length - 1].elements = h[h.length - 1].elements.concat(l))
                : (h = h.concat(t.slice(u, a.pathIndex))).push(new Ce.Selector(l)),
              (u = a.endPathIndex),
              (c = a.endPathElementIndex) >= t[u].elements.length && ((c = 0), u++)
          return (
            u < t.length &&
              c > 0 &&
              ((h[h.length - 1].elements = h[h.length - 1].elements.concat(t[u].elements.slice(c))),
              u++),
    ...
    Le = (function () {
      function e() {
        ;(this.contexts = [[]]), (this._visitor = new Pe(this))
      }
      return (
        (e.prototype.run = function (e) {
    ...
    je = (function () {
      function e(e) {
        ;(this._visitor = new Pe(this)), (this._context = e)
      }
      return (
    ...
    Ne = function (e) {
      ;(this._visitor = new Pe(this)), (this._context = e), (this.utils = new je(e))
    }
  Ne.prototype = {
    isReplacing: !0,
    run: function (e) {
    ...
    visitAtRuleWithoutBody: function (e, t) {
      if (!e.blocksVisibility()) {
        if ('@charset' === e.name) {
          if (this.charset) {
            if (e.debugInfo) {
              var i = new Ce.Comment('/* ' + e.toCSS(this._context).replace(/\n/g, '') + ' */\n')
    ...
    checkValidNodes: function (e, t) {
      if (e)
        for (var i = 0; i < e.length; i++) {
          var n = e[i]
          if (t && n instanceof Ce.Declaration && !n.variable)
            throw {
              message: 'Properties must be inside selector blocks. They cannot be in the root',
              index: n.getIndex(),
              filename: n.fileInfo() && n.fileInfo().filename
            }
          if (n instanceof Ce.Call)
            throw {
        ...
        (e.paths = e.paths.filter(function (e) {
          ...
          for (
            ' ' === e[0].elements[0].combinator.value &&
              (e[0].elements[0].combinator = new Ce.Combinator('')),
              t = 0;
            t < e.length;
            t++
          )
    ...
    _removeDuplicateRules: function (e) {
      if (e) {
        ...
        for (n = e.length - 1; n >= 0; n--)
          if ((i = e[n]) instanceof Ce.Declaration)
            if (r[i.name]) {
              ;(t = r[i.name]) instanceof Ce.Declaration &&
      ...
      if (e) {
        ...
        i.forEach(function (e) {
          if (e.length > 0) {
            var t = e[0],
              i = [],
              n = [new Ce.Expression(i)]
            e.forEach(function (e) {
              '+' === e.merge && i.length > 0 && n.push(new Ce.Expression((i = []))),
                i.push(e.value),
                (t.important = t.important || e.important)
            }),
              (t.value = new Ce.Value(n))
          }
        })
      }
    }
  ...
  var Be = function () {
      ...
      function u(i) {
        for (
          var n, a, c, h = l.i, f = t, p = l.i - o, v = l.i + s.length - p, d = (l.i += i), m = e;
          l.i < v;
          l.i++
        ) {
          if (((n = m.charCodeAt(l.i)), l.autoCommentAbsorb && 47 === n)) {
            ...
            if ('*' === a) {
              ...
              if (y >= 0) {
                ;(c = { index: l.i, text: m.substr(l.i, y + 2 - l.i), isLineComment: !1 }),
                  (l.i += c.text.length - 1),
                  l.commentStore.push(c)
                continue
              }
      ...
      return (
        ...
        (l.$parseUntil = function (t) {
          ...
          do {
            var m = e.charAt(v)
            if (0 === o && i(m))
              (r = e.substr(p, v - p)) ? c.push(r) : c.push(' '), (r = c), u(v - f), (d = !1)
            else {
              if (s) {
              ...
              switch (m) {
                case '\\':
                  v++, (m = e.charAt(v)), c.push(e.substr(p, v - p + 1)), (p = v + 1)
                  break
                case '/':
                ...
                case '"':
                  ;(n = l.$quoted(v))
                    ? (c.push(e.substr(p, v - p), n), (p = (v += n[1].length - 1) + 1))
                    : (u(v - f), (r = m), (d = !1))
                  break
                case '{':
                  a.push('}'), o++
        ...
        (l.peek = function (t) {
          if ('string' == typeof t) {
            for (var i = 0; i < t.length; i++) if (e.charAt(l.i + i) !== t.charAt(i)) return !1
            return !0
          }
          return t.test(s)
        }),
          ...
          ;(e = n),
            ...
            (r = a
              ? (function (e, t) {
                  ...
                  function m(t) {
                    var i = o - d
                    ;(i < 512 && !t) || !i || (v.push(e.slice(d, o + 1)), (d = o + 1))
                  }
                  for (o = 0; o < h; o++)
                      ...
                      switch (l) {
                        ...
                        case 47:
                          ...
                          if (47 == (u = e.charCodeAt(o + 1)))
                            for (
                              o += 2;
                              o < h && (!((u = e.charCodeAt(o)) <= 13) || (10 != u && 13 != u));
                              o++
                            );
                          else if (42 == u) {
                            for (
                          ...
                          continue
                        case 42:
                          if (o < h - 1 && 47 == e.charCodeAt(o + 1)) return t('unmatched `/*`', o)
                          continue
                      }
                  return 0 !== f
                    ? t(r > i && s > r ? 'missing closing `}` or `*/`' : 'missing closing `}`', i)
                    : 0 !== p
                    ? t('missing closing `)`', n)
                    : (m(!0), v)
                })(n, c)
    ...
    Ue = function e(t, i, n) {
      var r,
        s = Be()
      function o(e, t) {
        throw new O({ index: s.i, filename: n.filename, type: t || 'Syntax', message: e }, i)
      }
      function a(e, t) {
      ...
      function u(e) {
        var t = n.filename
        return { lineNumber: C(e, s.getInput()).line + 1, fileName: t }
      }
      return {
        parserInput: s,
        imports: i,
        ...
        parseNode: function (e, t, n, o, a) {
          ...
          try {
            ...
            for (var h = 0, f = void 0, p = void 0; (f = t[h]); h++)
              if (((p = c.i), (l = r[f]()))) {
                try {
            ...
            throw new O({ index: e.index + n, message: e.message }, i, o.filename)
          }
        },
        parse: function (r, o, a) {
          var l,
            ...
            p = ''
          if (
            ((u = a && a.globalVars ? e.serializeVars(a.globalVars) + '\n' : ''),
            (c = a && a.modifyVars ? '\n' + e.serializeVars(a.modifyVars) : ''),
            t.pluginManager)
          )
            for (var v = t.pluginManager.getPreProcessors(), d = 0; d < v.length; d++)
              r = v[d].process(r, { context: t, imports: i, fileInfo: n })
          ;(u || (a && a.banner)) &&
            ((p = (a && a.banner ? a.banner : '') + u),
            ((h = i.contentsIgnoredChars)[n.filename] = h[n.filename] || 0),
            (h[n.filename] += p.length)),
            (r = p + (r = r.replace(/\r\n?/g, '\n')).replace(/^\uFEFF/, '') + c),
            (i.contents[n.filename] = r)
          try {
            s.start(r, t.chunkInput, function (e, t) {
              throw new O({ index: t, type: 'Parse', message: e, filename: n.filename }, i)
            }),
              (Ce.Node.prototype.parse = this),
              (l = new Ce.Ruleset(null, this.parsers.primary())),
              (Ce.Node.prototype.rootNode = l),
              (l.root = !0),
              (l.firstRoot = !0),
              (l.functionRegistry = H.inherit())
          } catch (e) {
            return o(new O(e, i, n.filename))
          }
          var m = s.end()
          if (!m.isFinished) {
            ...
            g ||
              ...
              '}' === m.furthestChar
                ...
                : ')' === m.furthestChar
                ? (g += ". Possibly missing opening '('")
                : m.furthestReachedEnd && (g += '. Possibly missing something')),
              (f = new O({ type: 'Parse', message: g, index: m.furthest, filename: n.filename }, i))
          }
          var y = function (e) {
            return (e = f || e || i.error)
              ? (e instanceof O || (e = new O(e, i, n.filename)), o(e))
              : o(null, l)
          }
          if (!1 === t.processImports) return y()
          new De.ImportVisitor(i, y).run(l)
        },
        parsers: (r = {
          primary: function () {
          ...
          comment: function () {
            if (s.commentStore.length) {
              ...
              return new Ce.Comment(e.text, e.isLineComment, e.index, n)
            }
          },
          entities: {
            ...
            quoted: function (e) {
              ...
              if ((t = s.$quoted()))
                return s.forget(), new Ce.Quoted(t.charAt(0), t.substr(1, t.length - 2), r, i, n)
              s.restore()
            },
            keyword: function () {
              var e =
                s.$char('%') || s.$re(/^\[?(?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+\]?/)
              if (e) return Ce.Color.fromKeyword(e) || new Ce.Keyword(e)
            },
            call: function () {
              var e,
                t,
              ...
              if (!s.peek(/^url\(/i))
                if ((s.save(), (e = s.$re(/^([\w-]+|%|~|progid:[\w\.]+)\(/)))) {
                  if (((e = e[1]), (i = this.customFuncCall(e)) && (t = i.parse()) && i.stop))
                    return s.forget(), t
                  if (((t = this.arguments(t)), s.$char(')')))
                    return s.forget(), new Ce.Call(e, t, r, n)
                  s.restore("Could not parse call arguments or missing ')'")
                } else s.forget()
            },
            customFuncCall: function (e) {
              return { alpha: t(r.ieAlpha, !0), boolean: t(i), if: t(i) }[e.toLowerCase()]
              function t(e, t) {
            ...
            arguments: function (e) {
              ...
              for (s.save(); ; ) {
                ...
                s.$char(',') ||
                  ((s.$char(';') || t) &&
                    ((t = !0), (i = n.length < 1 ? n[0] : new Ce.Value(n)), o.push(i), (n = [])))
              }
            ...
            assignment: function () {
              ...
              if ((s.save(), (e = s.$re(/^\w+(?=\s?=)/i))))
                if (s.$char('=')) {
                  if ((t = r.entity())) return s.forget(), new Ce.Assignment(e, t)
                  s.restore()
                } else s.restore()
              else s.restore()
            },
            url: function () {
              ...
              if (((s.autoCommentAbsorb = !1), s.$str('url(')))
                return (
                  ...
                  l(')'),
                  new Ce.URL(
                    null != e.value || e instanceof Ce.Variable || e instanceof Ce.Property
                      ? e
                      : new Ce.Anonymous(e, t),
                    t,
                    n
                  )
                )
            ...
            variable: function () {
              ...
              if ((s.save(), '@' === s.currentChar() && (t = s.$re(/^@@?[\w-]+/)))) {
                ...
                return s.forget(), new Ce.Variable(t, i, n)
              }
              s.restore()
            },
            variableCurly: function () {
              ...
              if ('@' === s.currentChar() && (e = s.$re(/^@\{([\w-]+)\}/)))
                return new Ce.Variable('@' + e[1], t, n)
            },
            property: function () {
              var e,
                t = s.i
              if ('$' === s.currentChar() && (e = s.$re(/^\$[\w-]+/)))
                return new Ce.Property(e, t, n)
            },
            propertyCurly: function () {
              var e,
                t = s.i
              if ('$' === s.currentChar() && (e = s.$re(/^\$\{([\w-]+)\}/)))
                return new Ce.Property('$' + e[1], t, n)
            },
            color: function () {
              var e
              if (
                (s.save(),
                '#' === s.currentChar() &&
                  (e = s.$re(/^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})([\w.#\[])?/)) &&
                  !e[2])
              )
                return s.forget(), new Ce.Color(e[1], void 0, e[0])
              s.restore()
            },
            ...
            dimension: function () {
              if (!s.peekNotNumeric()) {
                ...
                return e ? new Ce.Dimension(e[1], e[2]) : void 0
              }
            },
            unicodeDescriptor: function () {
              var e
              if ((e = s.$re(/^U\+[0-9a-fA-F?]+(\-[0-9a-fA-F?]+)?/)))
                return new Ce.UnicodeDescriptor(e[0])
            },
            javascript: function () {
              var e,
                t = s.i
              ...
              if (s.$char('`')) {
                if ((e = s.$re(/^[^`]*`/)))
                  return s.forget(), new Ce.JavaScript(e.substr(0, e.length - 1), Boolean(i), t, n)
          ...
          variableCall: function (e) {
            ...
            if ((s.save(), a || ('@' === s.currentChar() && (a = s.$re(/^(@[\w-]+)(\(\s*\))?/))))) {
              ...
              o || (a = a[1])
              var l = new Ce.VariableCall(a, i, n)
              return !o && r.end()
                ? (s.forget(), l)
                : (s.forget(), new Ce.NamespaceValue(l, t, i, n))
            }
            s.restore()
          },
          extend: function (e) {
            ...
            if (s.$str(e ? '&:extend(' : ':extend(')) {
              do {
                ...
                ;(r = r && r[1]),
                  ...
                  (u = new Ce.Extend(new Ce.Selector(t), r, c, n)),
                  l ? l.push(u) : (l = [u])
              } while (s.$char(','))
              return a(/^\)/), e && a(/^;/), l
            }
          ...
          mixin: {
            call: function (e, t) {
              ...
              if ('.' === c || '#' === c) {
                if ((s.save(), (o = this.elements()))) {
                  if (
                    (s.$char('(') && ((a = this.args(!0).args), l(')'), (u = !0)),
                  ...
                  if ((!e && r.important() && (h = !0), e || r.end())) {
                    s.forget()
                    var p = new Ce.mixin.Call(o, a, f, n, !i && h)
                    return i ? new Ce.NamespaceValue(p, i) : p
                  }
                }
                s.restore()
              }
            ...
            elements: function () {
              for (
                var e, t, i, r, o, a = /^[#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/;
                (o = s.i), (t = s.$re(a));

              )
                (r = new Ce.Element(i, t, !1, o, n)), e ? e.push(r) : (e = [r]), (i = s.$char('>'))
              return e
            },
            args: function (e) {
              var t,
              ...
              for (s.save(); ; ) {
                ...
                var g = null
                if (
                  (e ? u.value && 1 == u.value.length && (g = u.value[0]) : (g = u),
                  g && (g instanceof Ce.Variable || g instanceof Ce.Property))
                )
                  if (s.$char(':')) {
                    if (
                      (p.length > 0 && (t && o('Cannot mix ; and , as delimiter types'), (i = !0)),
                ...
                l && p.push(l),
                  ...
                  s.$char(',')
                    ...
                    : ((m = ';' === s.$char(';')) || t) &&
                      ...
                      (t = !0),
                      p.length > 1 && (l = new Ce.Value(p)),
                      v.push({ name: n, value: l, expand: c }),
                      (n = null),
                      (p = []),
                      (i = !1))
              }
              return s.forget(), (f.args = t ? v : d), f
            },
            definition: function () {
              var e,
                t,
                ...
                o = [],
                l = !1
              if (!(('.' !== s.currentChar() && '#' !== s.currentChar()) || s.peek(/^[^{]*\}/)))
                if (
                  (s.save(),
                  (t = s.$re(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/)))
                ) {
                  e = t[1]
                  var u = this.args(!1)
                  ...
                  if (
                    ...
                    s.$str('when') && (n = a(r.conditions, 'expected condition')),
                    (i = r.block()))
                  )
                    return s.forget(), new Ce.mixin.Definition(e, o, i, n, l)
                  s.restore()
                } else s.restore()
            },
            ...
            if (s.$re(/^opacity=/i))
              return (
                (e = s.$re(/^\d+/)) ||
                  (e =
                    '@{' +
                    (e = a(r.entities.variable, 'Could not parse alpha')).name.slice(1) +
                    '}'),
                l(')'),
                new Ce.Quoted('', 'alpha(opacity=' + e + ')')
              )
          },
          element: function () {
            var e,
              ...
              (e =
                ...
                s.$char('(')
                  ? (i = this.selector(!1)) && s.$char(')')
                    ? ((e = new Ce.Paren(i)), s.forget())
                    : s.restore("Missing closing ')'")
                  : s.forget()),
              e)
            )
              return new Ce.Element(t, e, e instanceof Ce.Variable, r, n)
          },
          combinator: function () {
            var e = s.currentChar()
            if ('/' === e) {
              s.save()
              var t = s.$re(/^\/[a-z]+\//i)
              if (t) return s.forget(), new Ce.Combinator(t)
              s.restore()
            }
            if ('>' === e || '+' === e || '~' === e || '|' === e || '^' === e) {
              for (
                s.i++, '^' === e && '^' === s.currentChar() && ((e = '^^'), s.i++);
                s.isWhitespace();

              )
                s.i++
              return new Ce.Combinator(e)
            }
            return s.isWhitespace(-1) ? new Ce.Combinator(' ') : new Ce.Combinator(null)
          },
          selector: function (e) {
            var t,
              i,
            ...
            for (
              e = !1 !== e;
              ((e && (i = this.extend())) || (e && (c = s.$str('when'))) || (l = this.element())) &&
              (c
            ...
            if (t) return new Ce.Selector(t, u, h, f, n)
          ...
          selectors: function () {
            for (
              ...
              e.condition && o('Guards are only currently allowed on a single selector.'),
                (s.commentStore.length = 0)
            return t
          },
          attribute: function () {
            if (s.$char('[')) {
              ...
              return (
                ...
                (i = s.$re(/^[|~*$^]?=/)) &&
                  (t = n.quoted() || s.$re(/^[0-9]+%/) || s.$re(/^[\w-]+/) || n.variableCurly()),
                l(']'),
                new Ce.Attribute(e, i, t)
              )
            }
          },
          block: function () {
          ...
          blockRuleset: function () {
            var e = this.block()
            return e && (e = new Ce.Ruleset(null, e)), e
          },
          detachedRuleset: function () {
            ...
            if (
              (s.save(),
              !s.$re(/^[.#]\(/) ||
                ((t = (e = this.mixin.args(!1)).args), (i = e.variadic), s.$char(')')))
            ) {
              var n = this.blockRuleset()
              if (n)
                return (
                  s.forget(),
                  t ? new Ce.mixin.Definition(null, t, n, null, i) : new Ce.DetachedRuleset(n)
                )
              s.restore()
            } else s.restore()
          },
          ruleset: function () {
            ...
            if (
              ...
              s.forget()
              var r = new Ce.Ruleset(e, i, t.strictImports)
          ...
          declaration: function () {
            ...
            if ('.' !== u && '#' !== u && '&' !== u && ':' !== u)
              if ((s.save(), (e = this.variable() || this.ruleProperty()))) {
                if (
                  ((a = 'string' == typeof e) && (t = this.detachedRuleset()) && (i = !0),
                  (s.commentStore.length = 0),
                  !t)
                ) {
                  if (
                    ...
                    return s.forget(), new Ce.Declaration(e, t, !1, o, l, n)
                  t || (t = this.value()),
                    t ? (r = this.important()) : a && (t = this.permissiveValue())
                }
                if (t && (this.end() || i)) return s.forget(), new Ce.Declaration(e, t, r, o, l, n)
                s.restore()
              } else s.restore()
          },
          anonymousValue: function () {
            var e = s.i,
              t = s.$re(/^([^.#@\$+\/'"*`(;{}-]*);/)
            if (t) return new Ce.Anonymous(t[1], e)
          },
          permissiveValue: function (e) {
            ...
            if (!h()) {
              ...
              if (((r = h()), a.length > 0)) {
                if (((a = new Ce.Expression(a)), r)) return a
                c.push(a), ' ' === s.prevChar() && c.push(new Ce.Anonymous(' ', u))
              }
              if ((s.save(), (a = s.$parseUntil(l)))) {
                if (
                  ...
                  return s.forget(), new Ce.Anonymous('', u)
                var f = void 0
                for (t = 0; t < a.length; t++)
                  if (((f = a[t]), Array.isArray(f))) c.push(new Ce.Quoted(f[0], f[1], !0, u, n))
                  else {
                    t === a.length - 1 && (f = f.trim())
                    var p = new Ce.Quoted("'", f, !0, u, n)
                    ;(p.variableRegex = /@([\w-]+)/g), (p.propRegex = /\$([\w-]+)/g), c.push(p)
                  }
                return s.forget(), new Ce.Expression(c, !0)
              }
              s.restore()
            }
          },
            ...
            if (r) {
              ...
              if ((e = this.entities.quoted() || this.entities.url()))
                return (
                  ...
                  s.$char(';') ||
                    ((s.i = i), o('missing semi-colon or unrecognised media features on import')),
                  (t = t && new Ce.Value(t)),
                  new Ce.Import(e, t, a, i, n)
                )
            ...
            do {
              ;(e = i.keyword() || i.variable() || i.mixinLookup())
                ...
                : s.$char('(') &&
                  ...
                  s.$char(')')
                    ? t && e
                      ? r.push(new Ce.Paren(new Ce.Declaration(t, e, null, null, s.i, n, !0)))
                      : e
                      ? r.push(new Ce.Paren(e))
                      : o('badly formed media feature definition')
                    : o("Missing closing ')'", 'Parse'))
            } while (e)
            if ((s.forget(), r.length > 0)) return new Ce.Expression(r)
          },
          ...
          media: function () {
            ...
            if ((t.dumpLineNumbers && (a = u(l)), s.save(), s.$str('@media')))
              return (
                ...
                (i = this.block()) ||
                  o('media definitions require block statements after any features'),
                s.forget(),
                (r = new Ce.Media(i, e, l, n)),
          ...
          plugin: function () {
            ...
            if (s.$re(/^@plugin?\s+/)) {
              if (
                ((i = (t = this.pluginArgs()) ? { pluginArgs: t, isPlugin: !0 } : { isPlugin: !0 }),
                (e = this.entities.quoted() || this.entities.url()))
              )
                return (
                  s.$char(';') || ((s.i = r), o('missing semi-colon on @plugin')),
                  new Ce.Import(e, null, i, r, n)
                )
              ...
              if ((s.save(), (e = s.$re(/^@[a-z-]+/)))) {
                ...
                if (
                  ...
                  l
                    ...
                    : c
                    ? (i = this.expression()) || o('expected ' + e + ' expression')
                    : h &&
                  ...
                  return (
                    s.forget(), new Ce.AtRule(e, i, r, f, n, t.dumpLineNumbers ? u(f) : null, v)
                  )
          ...
          value: function () {
            ...
            if (t.length > 0) return new Ce.Value(t, i)
          },
          important: function () {
          ...
          sub: function () {
            ...
            if ((s.save(), s.$char('(')))
              return (e = this.addition()) && s.$char(')')
                ? (s.forget(), ((t = new Ce.Expression([e])).parens = !0), t)
            ...
            if ((t = (u = u.bind(this))()))
              return (
                s.$char('>')
                  ...
                  : s.$char('<')
                  ? (r = s.$char('=') ? '<=' : '<')
                  : s.$char('=') && (r = s.$char('>') ? '=>' : s.$char('<') ? '=<' : '='),
                r
                  ? (i = u())
                    ? (n = new Ce.Condition(r, t, i, l, !1))
                    : o('expected expression')
                  : (n = new Ce.Condition('=', t, new Ce.Keyword('true'), l, !1)),
                n
              )
          },
          operand: function () {
            ...
            var i =
              ...
              t.colorKeyword() ||
              t.mixinLookup()
            return e && ((i.parensInOp = !0), (i = new Ce.Negative(i))), i
          },
          expression: function () {
            var e,
              t,
            ...
            do {
              ;(e = this.comment())
                ? i.push(e)
                : ((e = this.addition() || this.entity()) instanceof Ce.Comment && (e = null),
                  e &&
                    (i.push(e),
                    s.peek(/^\/[\/*]/) || ((t = s.$char('/')) && i.push(new Ce.Anonymous(t, n)))))
            } while (e)
            if (i.length > 0) return new Ce.Expression(i)
          },
          property: function () {
          ...
          ruleProperty: function () {
            ...
            if (o) return (i = [new Ce.Keyword(o[1])]), s.forget(), i
            function a(e) {
              var t = s.i,
                n = s.$re(e)
                ...
                (e = i[t]),
                  (i[t] =
                    '@' !== e.charAt(0) && '$' !== e.charAt(0)
                      ? new Ce.Keyword(e)
                      : '@' === e.charAt(0)
                      ? new Ce.Variable('@' + e.slice(2, -1), r[t], n)
                      : new Ce.Property('$' + e.slice(2, -1), r[t], n))
              return i
            }
            s.restore()
          }
  ...
  function qe(e, t, i, n) {
    return t.eval(e) ? i.eval(e) : n ? n.eval(e) : new j()
  }
  function Te(e, t) {
    try {
      return t.eval(e), L.True
    } catch (e) {
      return L.False
    }
  }
  ;(Ue.serializeVars = function (e) {
    var t = ''
    for (var i in e)
  ...
  var Ze = (ze = {
    rgb: function (e, t, i) {
      ...
      if (e instanceof ne) {
        var r = e.value
        if (((e = r[0]), (t = r[1]), (i = r[2]) instanceof ie)) {
          var s = i
          ;(i = s.operands[0]), (n = s.operands[1])
        }
      }
      var o = ze.rgba(e, t, i, n)
      if (o) return (o.value = 'rgb'), o
    },
    rgba: function (e, t, i, n) {
      try {
        if (e instanceof c) return (n = t ? Ke(t) : e.alpha), new c(e.rgb, n, 'rgba')
        var r = [e, t, i].map(function (e) {
          return (
            (i = 255),
            (t = e) instanceof ee && t.unit.is('%') ? parseFloat((t.value * i) / 100) : Ke(t)
          )
          var t, i
        })
        return (n = Ke(n)), new c(r, n, 'rgba')
      } catch (e) {}
    },
    hsl: function (e, t, i) {
      var n = 1
      ...
      var o = ze.hsla(e, t, i, n)
      if (o) return (o.value = 'hsl'), o
    },
    hsla: function (e, t, i, n) {
      try {
        if (e instanceof c) return (n = t ? Ke(t) : e.alpha), new c(e.rgb, n, 'hsla')
        var r, s
        function o(e) {
        ...
        return (n = Ke(n)), new c(a, n, 'hsla')
      } catch (e) {}
    },
    hsv: function (e, t, i) {
      return ze.hsva(e, t, i, 1)
    },
    hsva: function (e, t, i, n) {
      var r, s
      ;(e = ((Ke(e) % 360) / 360) * 360), (t = Ke(t)), (i = Ke(i)), (n = Ke(n))
      var o = [
          i,
          i * (1 - t),
      ...
      return ze.rgba(255 * o[a[r][0]], 255 * o[a[r][1]], 255 * o[a[r][2]], n)
    },
    hue: function (e) {
    ...
    hsvhue: function (e) {
      return new ee(Qe(e).h)
    },
    hsvsaturation: function (e) {
      return new ee(100 * Qe(e).s, '%')
    },
    hsvvalue: function (e) {
      return new ee(100 * Qe(e).v, '%')
    },
    red: function (e) {
    ...
    luminance: function (e) {
      var t = (0.2126 * e.rgb[0]) / 255 + (0.7152 * e.rgb[1]) / 255 + (0.0722 * e.rgb[2]) / 255
    ...
    fade: function (e, t) {
      var i = He(e)
      return (i.a = t.value / 100), (i.a = We(i.a)), Je(e, i)
    },
    spin: function (e, t) {
      var i = He(e),
        n = (i.h + t.value) % 360
      return (i.h = n < 0 ? 360 + n : n), Je(e, i)
    },
    mix: function (e, t, i) {
      i || (i = new ee(50))
      var n = i.value / 100,
    ...
    greyscale: function (e) {
      return ze.desaturate(e, new ee(100))
    },
    contrast: function (e, t, i, n) {
      if (!e.rgb) return null
      if (
        (void 0 === i && (i = ze.rgba(255, 255, 255, 1)),
        void 0 === t && (t = ze.rgba(0, 0, 0, 1)),
        t.luma() > i.luma())
      ) {
        var r = i
        ;(i = t), (t = r)
      }
      return (n = void 0 === n ? 0.43 : Ke(n)), e.luma() < n ? i : t
    },
    argb: function (e) {
      return new j(e.toARGB())
    },
    color: function (e) {
      if (e instanceof ue && /^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})$/i.test(e.value)) {
    ...
    tint: function (e, t) {
      return ze.mix(ze.rgb(255, 255, 255), e, t)
    },
    shade: function (e, t) {
      return ze.mix(ze.rgb(0, 0, 0), e, t)
    }
  })
  function Xe(e, t, i) {
    var n,
  ...
  var Ye = {
    ...
    softlight: function (e, t) {
      var i = 1,
        n = e
      return (
        t > 0.5 && ((n = 1), (i = e > 0.25 ? Math.sqrt(e) : ((16 * e - 12) * e + 4) * e)),
        e - (1 - 2 * t) * n * (i - e)
      )
    },
  ...
  var tt = function (e) {
    ...
    it = {
      ...
      range: function (e, t, i) {
        ...
        for (var a = n; a <= r.value; a += s) o.push(new ee(a, r.unit))
        return new ne(o)
      },
      each: function (e, t) {
        var i,
        ...
        for (var h = 0; h < n.length; h++) {
          var f = void 0,
            ...
            v = n[h]
          v instanceof D
            ? ((f = 'string' == typeof v.name ? v.name : v.name[0].value), (p = v.value))
            : ((f = new ee(h + 1)), (p = v)),
            v instanceof U ||
              ((i = t.rules.slice(0)),
              a && i.push(new D(a, p, !1, !1, this.index, this.currentFileInfo)),
              c && i.push(new D(c, new ee(h + 1), !1, !1, this.index, this.currentFileInfo)),
              l && i.push(new D(l, f, !1, !1, this.index, this.currentFileInfo)),
              s.push(new K([new F([new m('', '&')])], i, t.strictImports, t.visibilityInfo())))
        }
        return new K([new F([new m('', '&')])], s, t.strictImports, t.visibilityInfo()).eval(
          this.context
        )
      }
    },
    nt = function (e, t, i) {
      if (!(i instanceof ee)) throw { type: 'Argument', message: 'argument must be a number' }
      return null == t ? (t = i.unit) : (i = i.unify()), new ee(e(parseFloat(i.value)), t)
    },
    rt = {
      ceil: null,
      floor: null,
  ...
  var ot = function (e, t) {
      ...
      for (i = 0; i < t.length; i++)
        if ((r = t[i]) instanceof ee)
          if (
            ...
            void 0 !== (n = void 0 !== h[''] && '' !== a && a === l ? h[''] : h[a]))
          )
            (o =
              '' === c[n].unit.toString() && void 0 !== u
                ? new ee(c[n].value, u).unify()
                : c[n].unify()),
              ((e && s.value < o.value) || (!e && s.value > o.value)) && (c[n] = r)
          else {
            if (void 0 !== l && a !== l) throw { type: 'Argument', message: 'incompatible types' }
            ;(h[a] = c.length), c.push(r)
          }
        else
          Array.isArray(t[i].value) &&
            Array.prototype.push.apply(t, Array.prototype.slice.call(t[i].value))
      return 1 == c.length
        ? c[0]
        : ((t = c
            .map(function (e) {
    ...
    at = {
      ...
      pow: function (e, t) {
        ...
        else if (!(e instanceof ee && t instanceof ee))
    ...
    lt = {
      e: function (e) {
        return new ue('"', e instanceof ve ? e.evaluated : e.value, !0)
      },
      escape: function (e) {
        return new j(
          encodeURI(e.value)
      ...
      '%': function (e) {
        for (
          ...
          n(r)
        return (i = i.replace(/%%/g, '%')), new ue(e.quote || '', i, e.escaped)
      }
    },
    ut = function (e, t) {
      return e instanceof t ? L.True : L.False
    },
    ct = function (e, t) {
      if (void 0 === t)
      ...
      return e instanceof ee && e.unit.is(t) ? L.True : L.False
    },
    ht = {
        ...
        if (!(e instanceof ee))
          throw {
            ...
            message:
              ...
              (e instanceof ie ? '. Have you forgotten parenthesis?' : '')
          }
        return (t = t ? (t instanceof L ? t.value : t.toCSS()) : ''), new ee(e.value, t)
      },
      'get-unit': function (e) {
        return new j(e.unit)
      }
    ...
    ft = function (e) {
      var t = { functionRegistry: H, functionCaller: re }
      return (
        H.addMultiple(Ge),
        H.add('default', Q.eval.bind(Q)),
        H.addMultiple(Ze),
        H.addMultiple(Xe),
        H.addMultiple(
          (function (e) {
            ...
            return {
              'data-uri': function (i, n) {
                ...
                if (!d.contents)
                  return (
                    r.warn('Skipped data-uri embedding of ' + o + ' because file not found'),
                    t(this, n || i)
                  )
                var m = d.contents
                if (p && !e.encodeBase64) return t(this, n)
                var g = 'data:' + s + ',' + (m = p ? e.encodeBase64(m) : encodeURIComponent(m)) + c
                return new ce(
                  new ue('"' + g + '"', g, !1, this.index, this.currentFileInfo),
                  this.index,
        ...
        H.addMultiple({
          'svg-gradient': function (e) {
            ...
            switch (
              (2 == arguments.length
                ? (arguments[1].value.length < 2 && v(), (t = arguments[1].value))
                : arguments.length < 3
                ? v()
            ...
            for (
              ...
              t[r] instanceof ne
                ...
                : ((s = t[r]), (o = void 0)),
                (s instanceof c &&
                  (((0 === r || r + 1 === t.length) && void 0 === o) || o instanceof ee)) ||
                  v(),
                ...
                (n +=
                  ...
                  '/>')
            return (
              (n += '</' + u + 'Gradient><rect ' + h + ' fill="url(#g)" /></svg>'),
  ...
  function pt(e, t) {
    ...
    'object' != typeof n ||
      ...
      ((n = Object.keys(n).map(function (e) {
        var t = n[e]
        return (
          t instanceof Ce.Value ||
            (t instanceof Ce.Expression || (t = new Ce.Expression([t])), (t = new Ce.Value([t]))),
          new Ce.Declaration('@' + e, t, !1, null, 0)
        )
      })),
      (r.frames = [new Ce.Ruleset(null, n)]))
    var s,
      o,
      a = [
        new De.JoinSelectorVisitor(),
        new De.MarkVisibleSelectorsVisitor(!0),
        new De.ExtendVisitor(),
        new De.ToCSSVisitor({ compress: Boolean(t.compress) })
      ],
      l = []
    if (t.pluginManager) {
      ...
      for (var u = 0; u < 2; u++)
        for (o.first(); (s = o.get()); )
          s.isPreEvalVisitor
            ...
            : (0 !== u && -1 !== a.indexOf(s)) || (s.isPreVisitor ? a.unshift(s) : a.push(s))
    }
    i = e.eval(r)
    for (u = 0; u < a.length; u++) a[u].run(i)
    if (t.pluginManager)
      for (o.first(); (s = o.get()); ) -1 === a.indexOf(s) && -1 === l.indexOf(s) && s.run(i)
    return i
  }
  var vt,
    dt = (function () {
  ...
  function wt(e, t) {
        ...
        return (
          (t.prototype.toCSS = function (t) {
            ...
            try {
              ...
              t.sourceMap
                ? ((n = new e(t.sourceMap)), (s.css = n.toCSS(i, a, this.imports)))
                : (s.css = i.toCSS(a))
            } catch (e) {
              throw new O(e, this.imports)
            }
            if (t.pluginManager)
              for (var l = t.pluginManager.getPostProcessors(), u = 0; u < l.length; u++)
                s.css = l[u].process(s.css, { sourceMap: n, options: t, imports: this.imports })
            for (var c in (t.sourceMap && (s.map = n.getExternalSourceMap()),
            (s.imports = []),
            this.imports.files))
              this.imports.files.hasOwnProperty(c) &&
          ...
          return (function () {
            function t(t) {
              ;(this._css = []),
                ...
                t.sourceMapFilename &&
                  (this._sourceMapFilename = t.sourceMapFilename.replace(/\\/g, '/')),
                (this._outputFilename = t.outputFilename),
                (this.sourceMapURL = t.sourceMapURL),
                t.sourceMapBasepath &&
                  (this._sourceMapBasepath = t.sourceMapBasepath.replace(/\\/g, '/')),
                t.sourceMapRootpath
                  ? ((this._sourceMapRootpath = t.sourceMapRootpath.replace(/\\/g, '/')),
              ...
              (t.prototype.add = function (e, t, i, n) {
                if (e) {
                  ...
                  if (t && t.filename) {
                    ...
                    if (
                      (this._contentsIgnoredCharsMap[t.filename] &&
                        ...
                        (u = u.slice(this._contentsIgnoredCharsMap[t.filename]))),
                      void 0 === u)
                    )
                    ...
                    if (n)
                      for (l = 0; l < r.length; l++)
                        this._sourceMapGenerator.addMapping({
                          ...
                          original: { line: s.length + l, column: 0 === l ? a.length : 0 },
                  ...
                  1 === r.length
                    ...
                    : ((this._lineNumber += r.length - 1), (this._column = o.length)),
                    this._css.push(e)
                }
              }),
                  ...
                  for (var t in this._contentsMap)
                    if (this._contentsMap.hasOwnProperty(t)) {
                      ...
                      this._contentsIgnoredCharsMap[t] &&
                        ...
                        this._sourceMapGenerator.setSourceContent(this.normalizeFilename(t), i)
                    }
            ...
            (t.prototype.push = function (t, i, n, s, o) {
              ...
              var u = function (e, i, n) {
                  ...
                  s.optional && e
                    ...
                    : (a.files[n] || s.inline || (a.files[n] = { root: i, options: s }),
                      e && !a.error && (a.error = e),
                      o(e, i, l, n))
                },
                c = {
              ...
              if (h) {
                var f,
                  ...
                  v = function (e) {
                    ...
                    ;(c.currentDirectory = h.getPath(i)),
                      ...
                      (c.filename = i)
                    var o = new q.Parse(a.context)
                    ;(o.processImports = !1),
                      (a.contents[i] = r),
                      (n.reference || s.reference) && (c.reference = !0),
                      s.isPlugin
                        ? (t = l.evalPlugin(r, o, a, s.pluginArgs, c)) instanceof O
                          ? u(t, null, i)
                          : u(null, t, i)
                        : s.inline
                        ? u(null, r, i)
                        : !a.files[i] || a.files[i].options.multiple || s.multiple
                        ? new Ue(o, a, c).parse(r, function (e, t) {
                            u(e, t, i)
                          })
                ...
                i && (d.ext = s.isPlugin ? '.js' : '.less'),
                  s.isPlugin
                    ...
                    : (p = h.loadFile(t, n.currentDirectory, d, e, function (e, t) {
                        e ? u(e) : v(t)
                      })),
    ...
    var u,
      ...
      h = (function (e, t, i) {
        var n = function (e, t, r) {
          ...
          if (((t.pluginManager = l), (o = new q.Parse(t)), t.rootFileInfo)) a = t.rootFileInfo
          else {
              ...
              t.plugins.forEach(function (e) {
                ...
                if (e.fileContent) {
                  if (
                    ...
                    (t = l.Loader.evalPlugin(i, o, h, e.options, e.filename)) instanceof O)
                  )
                    return r(t)
                } else l.addPlugin(e)
              }),
    ...
    for (var m in p.tree)
      ...
      else for (var g in ((d[m] = Object.create(null)), u)) d[m][g.toLowerCase()] = v(u[g])
  ...
  St.prototype = Object.assign(new ke(), {
    ...
    doXHR: function (e, t, i, n) {
      var r = new XMLHttpRequest(),
        s = !gt.isFileProtocol || gt.fileAsync
      function o(t, i, n) {
      ...
      'function' == typeof r.overrideMimeType && r.overrideMimeType('text/css'),
        yt.debug("XHR: Getting '" + e + "'"),
        r.open('GET', e, s),
        r.setRequestHeader('Accept', t || 'text/x-less, text/css; q=0.9, */*; q=0.5'),
        r.send(null),
        gt.isFileProtocol && !gt.fileAsync
    ...
    loadFile: function (e, t, i, n) {
      ...
      return new Promise(function (e, t) {
        if (i.useFileCache && xt[r])
          try {
            var n = xt[r]
            return e({ contents: n, filename: r, webInfo: { lastModified: new Date() } })
          } catch (e) {
            return t({
              filename: r,
        ...
        s.doXHR(
          ...
          i.mime,
          function (t, i) {
            ;(xt[r] = t), e({ contents: t, filename: r, webInfo: { lastModified: i } })
          },
          function (e, i) {
            t({ type: 'File', message: "'" + i + "' wasn't found (" + e + ')', href: r })
          }
        )
      })
    }
  ...
  var kt = function (t, n, r) {
      return {
            ...
            ? 'console' === r.errorReporting
              ? (function (e, t) {
                  ...
                  e.line &&
                    ...
                    a(e, 2, ''),
                    (o +=
                      ' on line ' + e.line + ', column ' + (e.column + 1) + ':\n' + s.join('\n'))),
                    e.stack && (e.extract || r.logLevel >= 4) && (o += '\nStack Trace\n' + e.stack),
                    n.logger.error(o)
                })(s, o)
              : 'function' == typeof r.errorReporting && r.errorReporting('add', s, o)
            : (function (n, s) {
                var o,
                  a,
                ...
                n.line &&
                  ...
                  n.stack &&
                    ...
                    (a += '<br/>Stack Trace</br />' + n.stack.split('\n').slice(1).join('<br/>')),
                  (u.innerHTML = a),
                  i(
                    t.document,
                    [
        ...
        remove: function (i) {
          r.errorReporting && 'html' !== r.errorReporting
            ? 'console' === r.errorReporting ||
              ('function' == typeof r.errorReporting && r.errorReporting('remove', i))
            : (function (i) {
  ...
  if (window.less)
    for (var At in window.less) window.less.hasOwnProperty(At) && (_t[At] = window.less[At])
  !(function (e, i) {
    t(i, n(e)),
    ...
    (_t.plugins = _t.plugins || []),
    window.LESS_PLUGINS && (_t.plugins = _t.plugins.concat(window.LESS_PLUGINS))
  var Mt,
    Et,
    Pt,
    Rt = (function (e, n) {
      ...
      o.addFileManager(l),
        ...
        (s.PluginLoader = Ct),
        (function (e, t) {
          ;(t.logLevel = void 0 !== t.logLevel ? t.logLevel : 'development' === t.env ? 3 : 1),
            t.loggers ||
              (t.loggers = [
                {
                  debug: function (e) {
          ...
          for (var i = 0; i < t.loggers.length; i++) e.logger.addListener(t.loggers[i])
        })(s, n)
      var u = kt(e, s, n),
        c = (s.cache =
          n.cache ||
            ...
            return {
              ...
              getCSS: function (e, t, i) {
                ...
                if (
                  ...
                  s &&
                    t.lastModified &&
                    new Date(t.lastModified).valueOf() === new Date(s).valueOf() &&
                    JSON.stringify(i) === o)
                )
                  return r
              }
                ...
                p(
                  function (e, t, i) {
                    t
                      ? u.add(t, 'inline')
                      : ((e.type = 'text/css'),
                        e.styleSheet ? (e.styleSheet.cssText = i.css) : (e.innerHTML = i.css))
                  },
                  null,
                  t
                )
            ...
            .then(function (t) {
              !(function (t) {
                ...
                if (
                  ...
                  if (!r && v) return (h.local = !0), void i(null, v, n, e, h, o)
                }
                u.remove(o),
                  (p.rootFileInfo = f),
      ...
      function m(e, t, i) {
        for (var n = 0; n < s.sheets.length; n++) d(s.sheets[n], e, t, s.sheets.length - (n + 1), i)
      }
      return (
        (s.watch = function () {
          return (
            ...
            new Promise(function (r, o) {
              ...
              ;(a = l = new Date()),
                0 === (h = s.sheets.length)
                  ? ((l = new Date()),
                    (c = l - a),
                    s.logger.info('Less has finished and no sheets were loaded.'),
                    r({ startTime: a, endTime: l, totalMilliseconds: c, sheets: s.sheets.length }))
                  : m(
                      function (t, n, f, p, v) {
                        if (t) return u.add(t, t.href || p.href), void o(t)
                        v.local
                          ? s.logger.info('Loading ' + p.href + ' from cache.')
                          : s.logger.info('Rendered ' + p.href + ' successfully.'),
                          i(e.document, n, p),
                          s.logger.info(
                            'CSS for ' + p.href + ' generated in ' + (new Date() - l) + 'ms'
                          ),
                          0 === --h &&
                            ((c = new Date() - a),
                            s.logger.info('Less has finished. CSS generated in ' + c + 'ms'),
                            r({
                              startTime: a,
                              endTime: l,
                              totalMilliseconds: c,
  ...
  function Ot(e) {
    e.filename && console.warn(e), _t.async || Et.removeChild(Pt)
  }
  return (
    (window.less = Rt),
    _t.onReady &&
      (/!watch/.test(window.location.hash) && Rt.watch(),
      _t.async ||
        ((Mt = 'body { display: none !important }'),
        (Et = document.head || document.getElementsByTagName('head')[0]),
        ((Pt = document.createElement('style')).type = 'text/css'),
        Pt.styleSheet ? (Pt.styleSheet.cssText = Mt) : Pt.appendChild(document.createTextNode(Mt)),
        Et.appendChild(Pt)),
      Rt.registerStylesheetsImmediately(),
      (Rt.pageLoadFinished = Rt.refresh('development' === Rt.env).then(Ot, Ot))),
    Rt
  )
})
