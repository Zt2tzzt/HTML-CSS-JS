...
- 底层是使用 Sass 预处理器构建，支持定制（Sass、Color、CSS variable ....）。（v5.x）
- 其中的网格系统、组件以及强大的 JavaScript 插件可以让我们快速搭建响应式网站。(v5.x)
- Bootstrap 是由 HTML、CSS 和 JS 编写可复用代码的集合（包括全局样式、组件、插件等），它是一个前端框架，使用该框架能够快速开发出响应的网站（即适配 PC、平板和移动端的网站）。
...
在 HTML 中引入 Bootstrap 后，需要添加的 2 个全局配置。
...
- Bootstrap 4 设了 5 个断点来构建响应式系统，分别为 Extra-Small、Small、Medium、Large、Extra large
...
<div class="container-lg">我是box</div>
